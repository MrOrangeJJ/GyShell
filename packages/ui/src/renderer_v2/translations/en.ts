export const en = {
  ...
  settings: {
    ...
    maxTokensPlaceholder: "Context Window (Default 200k)",
    requestParameters: "Request Parameters",
    requestParametersDescription:
      "Overrides are applied to every OpenAI-compatible POST body after GyShell's role defaults. Runtime-owned fields remain protected.",
    requestParameterCount: (count: number) => `${count} override${count === 1 ? "" : "s"}`,
    requestParameterUseDefault: "Use runtime default",
    customRequestParameters: "Custom fields",
    requestParameterJsonHint: "Exact OpenAI protocol keys",
    requestParameterKey: "Field name",
    requestParameterValue: "Value",
    requestParameterTypeText: "Text",
    requestParameterTypeNumber: "Number",
    requestParameterTypeBoolean: "Boolean",
    addRequestParameter: "Add field",
    noCustomRequestParameters: "No custom request fields.",
    requestParameterKeyRequired: "Enter a field name.",
    requestParameterDuplicate: "This field already exists.",
    requestParameterProtected: (key: string) => `${key} is managed by GyShell and cannot be overridden.`,
    requestParameterUseCommonField: (key: string) => `Use the ${key} field above.`,
    requestParameterInvalidNumber: "Enter a finite number or leave this blank.",
    requestParameterInvalidValue: "Enter a valid value for the selected type.",
    requestParameterUnsafe: "This field name is unsafe.",
    requestParameterKeyTooLong: "Field names must be 128 characters or fewer.",
    requestParameterTooDeep: "JSON values can be nested up to 8 levels.",
    requestParameterTooLarge: "Request parameters must stay under 64 KB.",
    requestParameterLimit: "A model can define up to 64 request fields.",
